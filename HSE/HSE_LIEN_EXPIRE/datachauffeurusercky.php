...
<div class="panel panel-default">
                        ...
                        <div class="col-md-12">
                            <form  role="form" class="form-horizontal" action="enregistrerchaufusercky.php" method="POST"> 
                 <div class="panel panel-success">
                      ...
                      <div class="col-lg-offset-5 col-lg-10">
                        ...
                        <button class="btn btn-danger" type="reset"><a href="datachauffeurusercky.php">Annuler</a></button>
                      </div>
                    </div>      
                    </div>      
                    </div>      
