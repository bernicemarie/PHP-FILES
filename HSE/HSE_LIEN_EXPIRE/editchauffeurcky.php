                ...
                <div class="page-content-wrap">                
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block">                                                 
                                <form  role="form" class="form-horizontal" action="modifchauffeurcky.php" method="POST">
...
<input name="id" type="hidden" value="<?php echo $ligne['id'];?>" class="form-control"/>
                      ...
                      <div class="col-lg-offset-5 col-lg-10">
                        ...
                        <button class="btn btn-danger" type="reset"><a href="listechauffeurcky.php">Annuler</a></button>
                      </div>
                    </div>      
                    </div>  
                    </div>  
