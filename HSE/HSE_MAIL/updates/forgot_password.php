    ...
    if (verifie($user)) {
        if ($stmt=mysqli_prepare($connect,"UPDATE users SET token='$token' WHERE user=?")) {
           ...
           mysqli_stmt_close($stmt);
                    ...
                    <a href="http://localhost/HSE/updates/reset.php?compte='.$user.'&token='.$token.' ">http://localhost/HSE/updates/reset.php?email='.$user.'&token='.$token.'</a>
                    </p>';
                    if($mail->send()){
                        $emailSent = true;
                           ...
                           <?php if (!isset($emailSent)):?>
                                ...
                                <div class="panel-body">
                                    <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                                        ...
                                        <div class="form-group">
                                            <input name="envoyer" class="btn btn-lg btn-primary btn-block" value="Réinitialiser votre mot de pass" type="submit">
