...
$id=$_GET['id'];
$list = $db->query('SELECT * FROM chauffeur WHERE id='.$id);
$ligne = $list->fetch();
 ?>
                ...
                <div class="page-content-wrap">                
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block">                                                 
                                <form  role="form" class="form-horizontal" action="modifchauffeur.php" method="POST">
                                  ...
                                  <div class="panel-body">                                                                        
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 ">                                            
                                              ...
                                              <input name="fc" type="text" value="<?php echo $ligne['fonction_chauff'];?>"class=" form-control"/>
                                            </div>                                            
...
<input name="id" type="hidden" value="<?php echo $ligne['id'];?>" class="form-control"/>
                      ...
                      <div class="col-lg-offset-5 col-lg-10">
                        ...
                        <button class="btn btn-danger" type="reset"><a href="listechauffeur.php">Annuler</a></button>
                      </div>
                    </div>      
                    </div>  
                    </div>  
