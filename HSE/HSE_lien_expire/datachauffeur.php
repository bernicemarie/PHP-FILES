...
<div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Ajout d'un chauffeur</h3>
                                    <div class="row">

                        <div class="col-md-12">
                            <form  role="form" class="form-horizontal" action="enregistrer.php" method="POST"> 
                  <div class="panel panel-success">
                                <div class="panel-heading ui-draggable-handle">
                                    <h3 class="panel-title"><strong>Ajouter un nouveau chauffeur</strong></h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 ">                                            
                                                ...
                                                <input name="mat" type="text" class=" form-control" required />
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 ">                                            
                                                ...
                                                <input name="nc" type="text" class=" form-control" required />
                                            </div>                                            
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 ">                                            
                                                ...
                                                <input name="pc" type="text" class=" form-control" required />
                                            </div>                                            
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6 ">                                            
                                                ...
                                                <input name="fc" type="text" class=" form-control" required />
                                            </div>                                            
                      ...
                      <div class="col-lg-offset-5 col-lg-10">
                        ...
                        <button class="btn btn-danger" type="reset"><a href="datachauffeur.php">Annuler</a></button>
                      </div>
                    </div>      
                    </div>      
                    </div>      
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">La liste des chauffeurs</h3>
...
while ($result=$req->fetch()) {
    echo '
     ...
     <tr>
                                                ...
                                                <td>'.$result['nom_chauff'].'</td>
                                                <td>'.$result['prenom_chauff'].'</td>
                                                <td>'.$result['fonction_chauff'].'</td>
                                                 
                                                <td>
<a class="btn btn-info" href="editchauffeur.php?id='.$result['id'].'">Mise à jour  </a> 
<a onclick="_delete(event)" class="btn btn-danger " href="delchauffeur.php?id='.$result['id'].'">Supprimer</a>
  </td>
                                            </tr>
    ';                                       
}
