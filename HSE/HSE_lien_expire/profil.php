  ...
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    <body>
            ...
            <div class="page-content">
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="utilisateurs.php">Home</a></li>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="#" method="POST">
                                        <input  value="3" name="id" class="form-control hidden">
                                            ...
                                            <label>Nom</label>
                                            <input value="SOW" class="form-control" Disabled>
                                        </div>
                                        <div class="form-group">
                                            <label>Prénom</label>
                                            <input class="form-control" value="Fatoumama Binta" Disabled >
                                        </div>
                                        <div class="form-group">
                                            <label>Login</label>
                                            <input type="test" class="form-control" value="fatoumatabinta.sow"  >
                                        </div>
                                        <div class="form-group">
                                            <input type="test" class="form-control hidden" name="login" value="Fatoumatabinta.sow" >
                                        </div>                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label>Statut</label>
                                            <input value="Gestionnaire"type="text" class="form-control " Disabled >
                                        </div>
