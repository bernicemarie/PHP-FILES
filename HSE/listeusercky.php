                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">La liste des utilisateurs </h3>
...
while ($result=$req->fetch()) {
    echo '
     ...
     <tr>
                                                ...
                                                <td>'.$result['user'].'</td>
              <td>
<a class="btn btn-info" href="editusercky.php?id='.$result['id'].'">Mise à jour  </a> 
<a onclick="_delete(event)" class="btn btn-danger " href="delusercky.php?id='.$result['id'].'">Supprimer</a>
