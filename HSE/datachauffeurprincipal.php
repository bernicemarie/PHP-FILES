...
<div class="panel panel-default">
                        ...
                        <div class="col-md-12">
                            <form  role="form" class="form-horizontal" action="enregistrerprincipal.php" method="POST"> 
...
<a class="btn btn-info" href="editchauffeurprincipal.php?id='.$result['id'].'">Mise à jour  </a> 
<a onclick="_delete(event)" class="btn btn-danger " href="delchauffeurprincipal.php?id='.$result['id'].'">Supprimer</a>
