...
$id=$_GET['id'];
$list = $db->query('SELECT * FROM login WHERE id='.$id);
$ligne = $list->fetch();
$list1 = $db->query('SELECT role FROM login WHERE role="Admincky"');
$ligne1 = $list1->fetch();
$list7 = $db->query('SELECT role FROM login WHERE role="Owner"');
$ligne7 = $list7->fetch();
$list2 = $db->query('SELECT role FROM login WHERE role="Adminbk"');
$ligne2 = $list2->fetch();
$list3 = $db->query('SELECT role FROM login WHERE role="Userbk"');
$ligne3 = $list3->fetch();
$list4 = $db->query('SELECT role FROM login WHERE role="Usercky"');
$ligne4 = $list4->fetch();
$list5 = $db->query('SELECT lieux FROM login WHERE lieux="Conakry"');
$ligne5 = $list5->fetch();
$list6 = $db->query('SELECT lieux FROM login WHERE lieux="Boke"');
$ligne6 = $list6->fetch();
 ?>
