...
$insert = $db->exec("INSERT INTO events(matricule,nom_seb,entreprise,evenement,shift,site,dat,heure,lieu,victime,cause,degat,description,action_immed,action_prevent,fonction,immatriculation,lieux) 
    VALUES('$matricule','$seb','$entreprise',
    '$evenement','$shift','$site',
    '$date','$heure',
    '$lieu','$victime',
    '$cause','$degat','$description',
    '$imme','$preventi','$fonction','$immatriculation','$lieux') ") ;
...
move_uploaded_file($_FILES['photo']['tmp_name'], $im);
    ...
    header('location:dataprincipal.php?msg=Insertion bien effectuée');
}
else{
