...
$ligne2 = $list2->fetch(); echo $ligne2['r2']; ?></div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-danger widget-item-icon" onclick="location.href='viewdatausercky.php';">
                                <div class="widget-item-left">
                                    <span class="fa fa-ambulance"></span>
                                </div>
                                <div class="widget-data">
            ...
            <div class="widget widget-warning widget-item-icon" onclick="location.href='imageuser.php';">
                         ...
                         END WIDGET REGISTRED     -->
                            ...
                            <!-- START WIDGET REGISTRED -->
                     <div class="widget widget-warning widget-item-icon" onclick="location.href='listechauffeuruser.php';">
                                <div class="widget-item-left">
                                    <span class="fa fa-male"></span>
                                </div>
                                <div class="widget-data">
