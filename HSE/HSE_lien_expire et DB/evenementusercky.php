                ...
                <div class="page-content-wrap">                
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block">                                                 
                         <form class="form-validate form-horizontal"  method="post" action="enregistrereventsusercky.php" enctype="multipart/form-data" >
    ...
    <div class="form-group ">
                      <label for="ccomment" class="control-label col-lg-4">Type Evenement<span class="required">*</span></label>
                        ...
                        <select name= "event"  class="form-control" id="formGender" required>
                                                <option value="">Choisissez</option>
                                                <option value="Accident avec arret">Accident avec arret</option>
                                                <option value="Depart de feux/Incendie<">Depart de feux/Incendie</option>
                                                <option value="Accident sans arret">Accident sans arret</option>
                                                <option value="Incident">Incident</option>
                                                <option value="Fatalité">Fatalité</option>
  ...
  <div class="row">
        ...
        <div class="form-group ">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-8">
                        <textarea name="observation" type="text" class=" form-control" rows="3" maxlength="180" required> </textarea>
                      </div>
                    </div>
                      </div>
                    </div>
