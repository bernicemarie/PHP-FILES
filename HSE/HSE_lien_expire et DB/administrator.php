    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="administrator.php">UMS-HSE <?php echo $_SESSION['lieux']; ?></a></li>
                ...
                <div class="page-content-wrap">
                    ...
                    <!-- START WIDGETS -->                    
                     <div class="row">
                        <div class="col-md-3">
                            ...
                            <!-- START WIDGET SLIDER -->
                            <div class="widget widget-danger widget-item-icon" onclick="location.href='degats.php';">
                                ...
                                <div class="widget-data">
                                    ...
                                    <div class="widget-title">Dégats enregistrés BOKE </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-danger widget-item-icon" onclick="location.href='#';">
                                ...
                                <div class="widget-data">
                                    <div class="widget-int num-count"><?php $list2 = $db->query("SELECT count(*) as r2 FROM events WHERE site='Site 1' and lieux='Boke'");
                                        $ligne2 = $list2->fetch(); echo $ligne2['r2']; ?></div>

                                    <div class="widget-title">évènement Site 1</div>
                        ...
                        <div class="col-md-3 ">
                            ...
                            <div class="widget widget-danger widget-item-icon" onclick="location.href='#';">
                                ...
                                <div class="widget-data">
                                    <div class="widget-int num-count">  <?php $list = $db->query("SELECT count(*) as r FROM events WHERE site='Site 2' and lieux='Boke'");
                                     $ligne = $list->fetch();echo $ligne['r']; ?> </div>
                                    <div class="widget-title ">évènement Site 2</div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-danger widget-item-icon" onclick="location.href='viewdatacky.php';">
                                <div class="widget-item-left">
                                ...
                                <div class="widget-data">
                                    <div class="widget-int num-count"><?php $list6 = $db->query("SELECT count(matricule) as r6 FROM events WHERE lieux='Conakry'");
                                       $ligne6 = $list6->fetch(); echo $ligne6['r6']; ?></div>
                                    <div class="widget-title">événements CONAKRY</div>
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="widget widget-warning widget-item-icon" onclick="location.href='imageadmin.php';">
                                <div class="widget-item-left">
                         ...
                         END WIDGET REGISTRED      -->   
                            ...
                            <!-- START WIDGET REGISTRED -->
                          <div class="widget widget-warning widget-item-icon" onclick="location.href='listechauffeur.php';">
                                <div class="widget-item-left">
                                    <span class="fa fa-male"></span>
                                </div>
                                <div class="widget-data">
                                    <div class="widget-int num-count"><?php $list3 = $db->query("SELECT count(matricule) as r3 FROM chauffeur WHERE matricule!= 'Affrété'");
                                    $ligne3 = $list3->fetch();  echo $ligne3['r3']; ?></div>
                                    <div class="widget-title">Chauffeurs BOKE</div>
                    ...
                    <div class="col-md-3">
                       ...
                       <div class="col-md-3">
                            ...
                            <!--START WIDGET REGISTRED -->
                            <div class="widget widget-warning widget-item-icon" onclick="location.href='sebview.php';">
                                <div class="widget-item-left">
                         ...
                         <div class="col-md-3">
                            ...
                            <!--START WIDGET REGISTRED -->
                            <div class="widget widget-warning widget-item-icon" onclick="location.href='affrétéview.php';">
                                <div class="widget-item-left">
                                    <span class="fa fa-car"></span>
                                </div>
                                <div class="widget-data">
