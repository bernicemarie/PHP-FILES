...
<div class="panel panel-default">
                        ...
                        <div class="col-md-12">
                            <form  role="form" class="form-horizontal" action="enregistrerentreprisecky.php" method="POST"> 
                 ...
                 <div class="col-md-6">
                    Entreprise : <br>
     <input name="en" type="text" class=" form-control" required />
                                            
                                        </div>
                                     
                 <div class="col-md-6"> Localité : <br>
     <input name="lo" type="text" class=" form-control" required />
...
while ($result=$req->fetch()) {
    echo '
     ...
     <tr>
                                                ...
                                                <td>
<a class="btn btn-info" href="editentreprisecky.php?id='.$result['id'].'">Mise à jour  </a> 
<a onclick="_delete(event)" class="btn btn-danger " href="delentreprisecky.php?id='.$result['id'].'">Supprimer</a>
  </td>
