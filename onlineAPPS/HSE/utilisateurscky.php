    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="utilisateurscky.php">UMS-HSE <?php echo $_SESSION['lieux']; ?></a></li>                    
            ...
            <div class="widget widget-warning widget-item-icon" onclick="location.href='imageusercky.php';">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="widget widget-danger widget-item-icon" onclick="location.href='degatsusercky.php';">
                                <div class="widget-item-left">
                                ...
                                <div class="widget-data">
                                    ...
                                    <div class="widget-title">EVENEMENTS <?php echo $_SESSION['lieux'];?></div>
                        ...
                        <div class="col-md-3 ">
                            ...
                            <div class="widget widget-danger widget-item-icon">
                                ...
                                <div class="widget-data">
                                    <div class="widget-int num-count">  <?php $list = $db->query("SELECT count(matricule) as r FROM events WHERE lieux='Boke'");
                        ...
                        <div class="col-md-3">
                            ...
                            <!-- START WIDGET REGISTRED -->
                          <div class="widget widget-warning widget-item-icon"  onclick="location.href='listechauffeurusercky.php';">
                                <div class="widget-item-left">
                                    <span class="fa fa-male"></span>
                                </div>
                                <div class="widget-data">
                                    ...
                                    $ligne3 = $list3->fetch();  echo $ligne3['r3']; ?></div>
                                    <div class="widget-title"><a style="color: white" href="listechauffeurusercky.php">Chauffeurs <?php echo $_SESSION['lieux']; ?></a></div>
                    ...
                    <div class="col-md-3">
                       ...
                       <div class="col-md-3">
                            ...
                            <!--START WIDGET REGISTRED -->
                            <div class="widget widget-warning widget-item-icon" onclick="location.href='sebviewusercky.php';">
                                <div class="widget-item-left">
                         ...
                         <div class="col-md-3">
                            ...
                            <!--START WIDGET REGISTRED -->
                            <div class="widget widget-warning widget-item-icon" onclick="location.href='affrétéviewusercky.php';">
                                <div class="widget-item-left">
                                    <span class="fa fa-car"></span>
                                </div>
                                <div class="widget-data">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([ 
          ...
          <?php 
             $element_text=['Total Accident Boke','Total Accident Conakry','Total Accident Boke Site 1','Total Accident Boke Site 2'];
