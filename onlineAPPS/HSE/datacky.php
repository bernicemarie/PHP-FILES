...
$list = $db->query("SELECT * FROM events where lieux= 'Conakry'");
$ligne = $list->fetch();
 ?>
...
<head>        
        ...
        <link rel="stylesheet" type="text/css" id="theme" href="updates/css/transformebig.css"/>
        <!-- EOF CSS INCLUDE -->                                      
    </head>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="#addnew" data-toggle="modal" class="btn btn-info btn-lg btn-flat"><i class="fa fa-plus"></i>Ajouter un évènement</a>
...
$req = $db->query('SELECT * FROM events where lieux= "Conakry"');
...
while ($result=$req->fetch()) {
    echo '
     ...
     <tr>
                                               ...
                                               <td>'.$result['action_immed'].'</td>
                                                <td>'.$result['action_prevent'].'</td>    
...
<a onclick="_delete(event)" class="btn btn-danger " href="delevenementcky.php?id='.$result['id'].'">Supprimer</a>
  </td>
                                            </tr>
    ';                                       
}
  ...
  ?>
       ...
       <div class="message-box animated fadeIn" data-sound="alert" id="mb-signout">
        ...
        <!-- END MESSAGE BOX-->
         <?php include 'includes/evenement_modal_cky.php'; ?>
        <!-- START PRELOADS -->
