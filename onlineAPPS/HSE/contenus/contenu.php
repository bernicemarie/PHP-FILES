            ...
            <div class="col-md-8">
               ...
               while ($row=mysqli_fetch_assoc($result)) {
                ...
                <p class="lead">
                  ...
                  <h2 class="text-center"><?php echo 'Société'.' '. $entreprise;?></h2>
                </p>
           <a href=""><img class="img-responsive"  style="width:600px;height:500px;"  src="../img/image/<?php echo $id.'.jpg';?>" alt="Pas d'image pour cet évènement"></a>

                <!-- <img class="img-responsive" src="images/<?php echo $post_image;?>" alt=""> -->
                 <p class="text-center btn-info" style="width:600px;height:20px;">UMS-HSE-EVENEMENTS</p>
