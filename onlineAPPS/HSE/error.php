...
<body>
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                 <span class=""> <img src="img/imag.png" alt="echec connexion"  weight="250" height="250"/></span>
                                <h4>Connexion à UMS - HSE Impossible!!!</span></h4>
                            ...
                            <div class="card nestable-cart">
                                ...
                                <div class="card-body">
                                    <div class="example box" data-options='{"direction": "vertical", "contentSelector": ">", "containerSelector": ">"}'>
                                        <div>
                                            <div>
                                                Vérifiez vos informations de connexion</br>
                                                 Ou contactez l'administrateur web pour résoudre le souci.</br>
                                               Retour à la page de connexion  <a href="contenus/index.php"><b>Cliquez ici </b></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
 ...
 <div class="row">
                            <div class="col-lg-12">
                                <div id="foot">
                                    <p>© 2021 - UMS Departement Système d'information | Etudes & Developpement </p>
                                </div>
                            </div>
                        </div>
