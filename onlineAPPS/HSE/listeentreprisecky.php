                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <a href="#addnew" data-toggle="modal" class="btn btn-info btn-lg btn-flat"><i class="fa fa-plus"></i>Ajouter une entreprise</a>
...
<a onclick="_delete(event)" class="btn btn-danger " href="delentreprisecky.php?id='.$result['id'].'">Supprimer</a>
  ...
  ?>         
       ...
       <div class="message-box animated fadeIn" data-sound="alert" id="mb-signout">
        ...
        <!-- END MESSAGE BOX-->
        <?php include 'includes/entreprise_cky_modal.php'; ?>
        <!-- START PRELOADS -->
