                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                 ...
                                 <div class="panel-body">
                                    <table id="customers2" class="table datatable table-bordered table-sm table-hover">
                                        <thead>
                                            <tr>
                                                <th>N° Rapport</th>
                                                <th>Matricule</th>
...
<a onclick="_delete(event)" class="btn btn-danger " href="delevenement.php?id='.$result['id'].'">Supprimer</a>
  </td>
                                            </tr>
    ';                                       
}
