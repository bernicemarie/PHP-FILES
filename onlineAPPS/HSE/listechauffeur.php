                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <a href="#addnew" data-toggle="modal" class="btn btn-info btn-lg btn-flat"><i class="fa fa-plus"></i>Ajouter un chauffeur</a>
...
<a onclick="_delete(event)" class="btn btn-danger " href="delchauffeur.php?id='.$result['id'].'">Supprimer</a>
  ...
  ?>         
       ...
       <div class="message-box animated fadeIn" data-sound="alert" id="mb-signout">
        ...
        <!-- END MESSAGE BOX-->
         <?php include 'includes/chauffeur_boke_modal.php'; ?>
        <!-- START PRELOADS -->
