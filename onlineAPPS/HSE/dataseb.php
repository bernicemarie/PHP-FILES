...
<div class="panel panel-default">
                        ...
                        <div class="col-md-12">
                            <form  role="form" class="form-horizontal" action="enregistrerseb.php" method="POST"> 
...
while ($result=$req->fetch()) {
    echo '
     ...
     <tr>
                                                ...
                                                <td>
<a class="btn btn-info" href="editseb.php?id='.$result['id'].'">Mise à jour  </a> 
<a onclick="_delete(event)" class="btn btn-danger " href="delseb.php?id='.$result['id'].'">Supprimer</a>
