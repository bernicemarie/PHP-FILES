            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                     ...
                     <div class='huge'><?php echo  $comments_count=boardcountuser('comments','comment_author',$_SESSION['username']);?></div>
                      <div> Mes Commentaires</div>
                    </div>
                </div>
            </div>
            <a href="comments.php">
        ...
        <div class="panel panel-red">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class='huge'><?php echo  $categories_count=boardcount('categories');?></div>
                         <div>Cours</div>
                    </div>
                </div>
            </div>
