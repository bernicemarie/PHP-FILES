    ...
    foreach ($_POST['checkboxArray'] as $checkPostId_Value) {
        ...
        switch ($bulk_options) {
          case 'Actif':
            ...
            $query="UPDATE posts SET post_status='$bulk_options' WHERE post_id= $checkPostId_Value AND username='$the_username'";
            $result=mysqli_query($connect,$query);
            if (!$result) {
              die('errrrroooorrr'.mysqli_error($connect));
            }
            ...
            $query="UPDATE posts SET posts_views_count=0 WHERE post_id= $checkPostId_Value AND username='$the_username'";
            $result=mysqli_query($connect,$query);
            if (!$result) {
              die('errrrroooorrr'.mysqli_error($connect));
            }
          ...
          case 'Supprimer':
            ...
            $query="DELETE FROM posts  WHERE post_id= $checkPostId_Value AND username='$the_username'";
             $result=mysqli_query($connect,$query);
             if (!$result) {
              die('errrrroooorrr'.mysqli_error($connect));
               }
          ...
          default:
            ...
            break;
                ...
                set_message("Vous n'êtes pas le propriétaire de cette publication");
            }
  ?>
