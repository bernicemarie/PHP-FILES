...
<?php  include "include/header_image.php"; ?>
 ...
 if (password_verify($password,$db_password) && $db_status=='valide') {
       ...
       if ($_SESSION['user_role']=='admin') {
       	header("Location: ../cms/admin/index_admin.php");   
       }
 	 else if ($_SESSION['user_role']=='user') {
 	 	header("Location: ../cms/admin/index_user.php");   
 	 }
 }
 else {
								...
								<form id="login-form" role="form" autocomplete="off" class="form" method="post">
									...
									<div class="form-group">
										<div class="input-group">
		                                   ...
		                                   <input name="password" type="password" class="form-control" id="myInput" placeholder="Entrez votre mot de pass"  required>
										</div>
