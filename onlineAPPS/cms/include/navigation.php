                  ...
                  ?>
                   <ul class="nav navbar-nav">
                     ...
                     <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="navbar-brand" href="amuse-toi/jeux.php" class="dropdown-Item" target="_blank" style="color: black">Jeux de nombre</a>
                        <a class="navbar-brand" href="amuse-toi/carte/carte.php" class="dropdown-Item" target="_blank" style="color: black">Jeux de carte</a>
                         <br>
             ...
             <ul class="nav navbar-nav">
                ...
                while ($row=mysqli_fetch_assoc($result)) {
                 ...
                 <?php if (!isset($_SESSION['user_role'])) {
                  ...
                  echo' <li><a href="../cms/admin/posts.php?source=add_post">Ajouter un Post</a></li>';
                 }
                  ?>
                 ...
                 <?php 
                  ...
                  ?>
                   ...
                   //echo'<a class="navbar-brand"  href="login">Connexion</a>';
                   echo'<li><a href="../cms/admin/logout.php">Déconnexion</a></li>';
                 } 
                 else{
                  echo'';
                 }
