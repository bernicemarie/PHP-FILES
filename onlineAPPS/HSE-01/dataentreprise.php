...
<div class="panel panel-default">
                        ...
                        <div class="col-md-12">
                            <form  role="form" class="form-horizontal" action="enregistrerentreprise.php" method="POST"> 
...
while ($result=$req->fetch()) {
    echo '
     ...
     <tr>
                                                ...
                                                <td>
<a class="btn btn-info" href="editentreprise.php?id='.$result['id'].'">Mise à jour  </a> 
<a onclick="_delete(event)" class="btn btn-danger " href="delentreprise.php?id='.$result['id'].'">Supprimer</a>
  </td>
