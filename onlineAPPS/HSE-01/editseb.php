...
$id=$_GET['id'];
$list = $db->query('SELECT * FROM vehicule WHERE id='.$id);
$ligne = $list->fetch();
 ?>
...
<div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Edition d'un Seb</h3>
                                    <div class="row">

                        <div class="col-md-12">
                            <form  role="form" class="form-horizontal" action="modifseb.php" method="POST"> 
                 ...
                 <div class="col-md-6">
                    N° Seb : <br>
     <input name="nseb" type="text" value="<?php echo $ligne['nom_seb'];?>" class="form-control"/>
                                            
                                        </div>
                                     
                 <div class="col-md-6"> Modèle: <br>
     <input name="im" type="text" value="<?php echo $ligne['modele'];?>" class="form-control"/>
...
<input name="id" type="hidden" value="<?php echo $ligne['id'];?>" class="form-control"/>
      ...
      <div class="btn-group pull-right">
                                    ...
                                    <div class="btn pull-right">
                                        ...
                                        <button class="btn btn-danger" type="reset"><a href="dataseb.php">Annuler</a></button>
