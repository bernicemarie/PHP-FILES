...
<div class="panel panel-default">
                        ...
                        <div class="col-md-12">
                            <form  role="form" class="form-horizontal" action="enregistrerchaufuser.php" method="POST"> 
                 <div class="panel panel-success">
                      ...
                      <div class="col-lg-offset-5 col-lg-10">
                        ...
                        <button class="btn btn-danger" type="reset"><a href="datachauffeuruser.php">Annuler</a></button>
                      </div>
                    </div>      
                    </div>      
                    </div>      
                    ...
                    <?php if (!empty($_GET["msg"])) {?>
                                            <div class="panel panel-success">
                                                <h3 class="panel-title" span style="color:red;"><strong><?=$_GET["msg"]?></strong></h3>
                                            </div>
                                        <?php }?>
