...
<div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Ajout Entreprise</h3>
                                    <div class="row">

                        <div class="col-md-12">
                            <form  role="form" class="form-horizontal" action="enregistrerentrepriseprincipal.php" method="POST"> 
                 ...
                 <div class="col-md-6">
                    Entreprise : <br>
     <input name="en" type="text" class=" form-control"/>
                                            
                                        </div>
                                     
                 <div class="col-md-6"> Localité : <br>
     <input name="lo" type="text" class=" form-control"/>
      ...
      <div class="btn-group pull-right">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">La liste des Entreprises</h3>
                                    <div class="btn-group pull-right">
...
while ($result=$req->fetch()) {
  ...
  <a class="btn btn-info" href="editentrepriseprincipal.php?id='.$result['id'].'">Mise à jour  </a> 
<a onclick="_delete(event)" class="btn btn-danger " href="delentrepriseprincipal.php?id='.$result['id'].'">Supprimer</a>
