...
$req = $db->query('SELECT * FROM events where lieux= "Conakry" OR lieux="Boke"');
...
<a onclick="_delete(event)" class="btn btn-danger " href="delevenementprincipal.php?id='.$result['id'].'">Supprimer</a>
