                ...
                <div class="page-content-wrap">                
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="block">                                                 
                                <form  role="form" class="form-horizontal" action="modifevent.php" method="POST">
                                 <div class="form-group">
                 <div class="col-md-4">

                    Matricule: <br>
<input name="mati" type="text" value="<?php echo $ligne['matricule'];?>" class="form-control"/>
       
                                        </div>
                                     
                 <div class="col-md-4"> Seb: <br>
     <input name="seb" type="text" value="<?php echo $ligne['nom_seb'];?>" class="form-control"/>
                                            
                                       
                                    </div> 

                 <div class="col-md-4"> Entreprise : <br>
     <input name="entreprise" type="text" value="<?php echo $ligne['entreprise'];?>" class="form-control"/> 
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="form-group">
                 <div class="col-md-4">
                    Description: <br>
     <input name="description" type="text" value="<?php echo $ligne['description'];?>" class="form-control"/>
                                            
                                        </div>
                                     
                 <div class="col-md-4"> Action Immediate: <br>
     <input name="ai" type="text" value="<?php echo $ligne['action_immed'];?>" class="form-control"/>     
                                       
                                    </div> 

                 <div class="col-md-4"> Action Preventive: <br>
     <input name="ap" type="text" value="<?php echo $ligne['action_prevent'];?>" class="form-control"/>
