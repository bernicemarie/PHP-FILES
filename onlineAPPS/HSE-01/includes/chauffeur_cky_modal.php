              ...
              <input type="text" class="form-control form-control-sm" name="mat" placeholder="Matricule du chauffeur" required>
                ...
                <br>
                    ...
                    <input type="text" class="form-control form-control-sm" placeholder="Prenom du chauffeur" name="pc" required>
                     ...
                     <br>
                    <div class="mb-3">
                        <input type="text" class="form-control form-control-sm" placeholder="Telephone du chauffeur" name="fc" required>
                    </div>
                     <br>
                      <div class="modal-footer">
              <button type="reset" class="btn btn-danger btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> <a href="listechauffeurcky.php">Annuler</a></button>
