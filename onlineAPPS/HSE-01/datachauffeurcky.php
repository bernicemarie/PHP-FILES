...
<div class="panel panel-default">
                      ...
                      <div class="col-lg-offset-5 col-lg-10">
                        ...
                        <button class="btn btn-danger" type="reset"><a href="datachauffeurcky.php">Annuler</a></button>
                      </div>
                    </div>      
                    </div>      
                    </div>      
...
<a class="btn btn-info" href="editchauffeurcky.php?id='.$result['id'].'">Mise à jour  </a> 
<a onclick="_delete(event)" class="btn btn-danger " href="delchauffeurcky.php?id='.$result['id'].'">Supprimer</a>
