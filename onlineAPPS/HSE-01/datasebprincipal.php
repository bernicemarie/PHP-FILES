...
<div class="panel panel-default">
                        ...
                        <div class="col-md-12">
                            <form  role="form" class="form-horizontal" action="enregistrersebprincipal.php" method="POST"> 
                 <div class="form-group">
                 <div class="col-md-6">
                    N° Seb : <br>
     <input name="nseb" type="text" class=" form-control"/>
                                            
                                        </div>
                                     
                 <div class="col-md-6"> Modèle: <br>
     <input name="im" type="text" class=" form-control"/>
...
<a class="btn btn-info" href="editsebprincipal.php?id='.$result['id'].'">Mise à jour  </a> 
<a onclick="_delete(event)" class="btn btn-danger "href="delsebprincipal.php?id='.$result['id'].'">Supprimer</a>
