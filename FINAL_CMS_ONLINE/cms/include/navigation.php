         ...
         <div class="navbar-header">
             ...
             <a class="navbar-brand" href="index">Maison</a>
                 ...
                 <?php if (!isset($_SESSION['user_role'])) {
                  ...
                  ?>
                   <a class="navbar-brand" href="amuse-toi/jeux" target="">Jeux</a>
         </div>
         ...
         <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
             <ul class="nav navbar-nav">
                ...
                while ($row=mysqli_fetch_assoc($result)) {
                 ...
                 <li><a href="infos.php">Lisez-moi</a></li>
                 ...
                 echo'<li><a href="../cms/admin/index_admin">Mon Espace De Travail</a></li>';
                  }
                 else {
                     echo'<li><a href="../cms/admin/index_user">Mon Espace De Travail</a></li>';
                 }
                  ?>
                 ...
                 <?php 
                   ...
                   if (isset($_SESSION['username'])) {
                       if (isset($_GET['p_id'])) {
                           ...
                           echo "<li><a href='../cms/admin/posts?source=edit_post&p_id=$the_post_id'>Editer ce post </a></li>";
