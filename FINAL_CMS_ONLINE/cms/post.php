...
?>
                  ...
                  if (isset($_POST['envoyer'])) {
                    $comment_post_id=$the_post_id=escapecontact($_GET['p_id']);
                ...
                <div class="well">
                    ...
                    <form role="form" action="" method="POST">
                         <div class="form-group">
                             ...
                             <input type="text" name="comment_author" value="<?php echo $username ;?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="comment_date" class="control-label col-lg-4">Date <span class="required">*</span></label>
                             <input type="date" name="comment_date" class="form-control" value="<?php echo date('Y-m-d'); ?>" disabled>
                        </div>
                         <div class="form-group">
                             <label for="comment_content" class="control-label col-lg-4">Commentaire<span class="required">*</span></label>
                            <textarea name ="comment_content" class="form-control"  class="form-control" id="body" maxlength="300"></textarea>
                        </div>
...
include("include/footer.php");
 ...
 <script>
    ...
    <script type="text/javascript" src="../cms/admin/js/textedit.js"></script>
