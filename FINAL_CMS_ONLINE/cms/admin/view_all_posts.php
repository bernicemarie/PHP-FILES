 ...
 <table class="table table-bordered table-hover">
    ...
    <td><input type='checkbox' class='checkboxes' name="checkboxArray[]" value="<?php echo $post_id;?>"></td>
                      ...
                      echo "<td><img width='50' height='50' src='../images/$post_image'></td>";
                        ...
                        echo "<td><a onClick=\"javascript: return confirm('Voulez-vous éditer cette ligne?');\" class='btn btn-primary' href='?source=edit_post&p_id=$post_id'>Editer</a></td>";
 ...
 <?php
              ...
              //echo "<td><a onclick='_delete(event)' class='btn btn-danger' href='posts.php?delete=$post_id'>Supprimer</a></td>";
                  ...
                  unlink($path_image);
                    ...
                    $result=mysqli_query($connect,$query);
                    if ($result) {
                      header('Location:posts?message=Bien supprimé');
                    }
                    else{
                      die('Aucune suppression possible'.mysqli_error($connect));
                    } 
