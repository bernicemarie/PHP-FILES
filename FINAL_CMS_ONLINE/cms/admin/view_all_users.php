...
echo"<td><a onClick=\"javascript: return confirm('Voulez-vous éditer cette ligne?');\" class='btn btn-primary ' href='?source=edit_user&userid=$user_id'>Editer</a></td>";
echo"<td><a onClick=\"javascript: return confirm('Voulez-vous changer son status?');\" class='btn btn-primary ' href='users.php?admin=$user_id'>Admin</a></td>";
echo"<td><a onClick=\"javascript: return confirm('Voulez-vous changer son status?');\"' class='btn btn-primary ' href='users.php?user=$user_id'>User</a></td>";
...
echo"<td><a onClick=\"javascript: return confirm('Voulez vous supprimer cet utilisateur?');\" class='btn btn-danger' href='users.php?delete=$user_id'>Supprimer</a></td>";
                  ...
                  if (isset($_GET['delete'])) {
                    ...
                    $result=mysqli_query($connect,$query);
                      header('location:users?message=Bien supprimé');  
                    ...
                    $result=mysqli_query($connect,$query);
                      header('location:users?message=Modifiation faite!');  
