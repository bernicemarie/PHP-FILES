...
if (isset($_SESSION['username'])) {
 ...
 user_role='$role'  WHERE username='$username'";
  ...
  if (!$query_update_result) {
   ...
   header("Location:profile?modification faite");
                ...
                <form class="form-validate form-horizontal" action=""  method="POST"  enctype="multipart/form-data">
                  ...
                  <div class="col-md-5">  
                     ...
                     <div class="form-group ">
                      ...
                      <div class="col-lg-8">
                         <input  autocomplete="off" name="motdepass" type="password" class=" form-control" placeholder="Votre nouveau mot de pass"  />
                      </div>
                    </div>
                    <div class="form-group ">
