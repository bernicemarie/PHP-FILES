 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
                    ...
                    echo '<a class="navbar-brand" href="index_admin">VIVE NOUS</a>';
                } 
                 else echo '<a class="navbar-brand" href="index_user">VIVE NOUS</a>';
                ?>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
               <li><a href="">utilisateurs en ligne : <span class="usersonline"></span>  </a><li> 
               <li><a href="../index">RETOUR</a></li>
                <li class="dropdown">
                ...
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <?php if (isset($_SESSION['user_role']) && $_SESSION['user_role']=='admin') {
                            echo '<a href="index_admin"><i class="fa fa-fw fa-dashboard"></i> Tableau de Bord</a>';
                        } 
                         else echo '<a href="index_user"><i class="fa fa-fw fa-dashboard"></i> Tableau de Bord</a>';
                        ?>
                    ...
                    <li>
                        ...
                        <ul id="posts_dropdown" class="collapse">
                         ...
                         <li>
                        <a href="categories.php"><i class="fa fa-fw fa-file"></i>Ajouter un cours</a>
                    </li>
                    ...
                    <?php 
                        ...
                        <ul id="users" class="collapse">
                            ...
                            <li>
                                <a href="online_users">Utilisateurs en ligne</a>
                            </li>
                        </ul>
                    </li>';
                    ...
                    <li>
                        <a href="info"><i class="fa fa-fw fa-dashboard"></i>A Propos</a>
                    </li>
                    <li>
