...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <p class="lead">
                Postée par <a
                    href="author_posts.php?author=<?php echo $post_author;?> &p_id=<?php echo $post_id;?>"><?php echo $username;?></a>
            </p>
            ...
            <br>
            <a class="btn btn-primary" href="post.php?p_id=<?php echo $post_id;?>">Laissez un commentaire <span
