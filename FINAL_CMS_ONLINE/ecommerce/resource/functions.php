...
function get_current_slide_in_admin(){
    ...
    <img class="img-responsive" src="../../resource/uploads/{$slide_image}" alt="">
...
$slide_active = <<<DELIMETER
 ...
 <div class="item active">
    <img class="slide-image" src="../resource/uploads/{$slide_image}" alt="">
</div>
...
<div class="col-xs-6 col-md-3 image_container">
    ...
    <a href="index.php?delete_slide_id={$row['slide_id']}">
         ...
         <img  class="img-responsive slide_image" src="../../resource/uploads/{$slide_image}" alt="">
