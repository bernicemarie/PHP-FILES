 ...
 ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                if($_SERVER['REQUEST_URI'] == "/developper-pour-tous/ecommerce/public/admin/" || $_SERVER['REQUEST_URI'] == "/developper-pour-tous/ecommerce/public/admin/index.php")  {


                   include(TEMPLATE_BACK . "/admin_content.php");
                    //include(TEMPLATE_FRONT . "/thank_you.php");
