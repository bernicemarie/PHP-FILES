    ...
    $username=$_SESSION['username'];
            ...
            <ul class="nav navbar-right top-nav">
               ...
               <li><a href="../index.php">RETOUR</a></li>
                <li class="dropdown">
                     <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i><img  width='50' height='40' src="../../cms/images/<?php echo $user_image;?>" alt="Mettez une image en cliquant sur Profile, côté gauche"></i>
                    <?php }};?>    
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="posts_dropdown" class="collapse">
                            <li>
                                <a href="posts.php?source=add_post">Ajouter un Post</a>
                            </li>
                            <li>
                    ...
                    <?php 
                        ...
                        <ul id="users" class="collapse">
                            <li>
                                <a href="users.php?source=add_user">Ajouter</a>
                            </li>
                            <li>
                                <a href="users.php">List Users</a>
                            </li>
                             <li>
                                <a href="users.php?source=password_user">Changer Mot de Pass</a>
                            </li>
                            <li>
