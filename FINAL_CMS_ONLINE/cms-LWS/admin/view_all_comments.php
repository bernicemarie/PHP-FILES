 <table class="table table-bordered table-hover">
                      <thead>
                        <tr>
                          ...
                          <th>L'auteur du commentaire</th>
                          <th>Commentaire</th>
                          <th>Email</th>
                          <th>Etat du commentaire</th>
                           <th>Date comentaire</th>
                          <th>L'image commentée</th>
                                    ...
                                    <?php 
                                      ...
                                      // $username=$row['username'];
                                       ...
                                       while($row1=mysqli_fetch_assoc($select_post_id_query)){
                                        ...
                                        if (empty($post_title)) {
                                         $post_title="L'image a été supprimée";
                                         echo"<td>$post_title</td>";
                                 }
                                        echo"<td><a href='../post.php?p_id=$post_id'>$post_title</a></td>" ; 
                                      
 if (isset($_SESSION['username']) && $_SESSION['username']== $comment_author) {
echo"<td><a onClick=\"javascript: return confirm('Voulez-vous approuver ce commentaire?');\" class='btn btn-primary ' href='comments.php?approuve=$comment_id'>approuver</a></td>";
echo"<td><a onClick=\"javascript: return confirm('Voulez-vous désapprouver ce commentaire?');\" class='btn btn-primary ' href='comments.php?desapprouve=$comment_id'>Désapprouver</a></td>";
echo"<td><a onClick=\"javascript: return confirm('Voulez-vous supprimer ce commentaire?');\" class='btn btn-danger' href='comments.php?delete=$comment_id'>Supprimer</a></td>";
 }
